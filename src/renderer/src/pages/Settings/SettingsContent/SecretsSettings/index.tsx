...
export const SecretsSettings = ({ title, icon }: PropType) => {
  ...
  return (
    <>
      ...
      <div className="p-4">
        <div className="bg-neutral-500/30 rounded-md pb-2">
          <Table className="min-w-full bg-transparent rounded-md">
            <TableRow className="hover:bg-transparent  border-b border-white/5 rounded-md">
              ...
              <TableCell className="px-4 py-2 text-left text-white rounded-tr-md"></TableCell>
            </TableRow>
            {secrets.map((secret, index) => (
              <TableRow key={index} className="hover:bg-transparent border-none rounded-b-md">
                <TableCell className="px-4 py-2">
                  <Input
                    ...
                    className="w-full bg-transparent hover:bg-transparent text-white placeholder:text-white/30 border border-white/20 rounded-lg px-3 py-2"
                  />
                </TableCell>
                <TableCell className="px-4 py-2">
                  <Input
